...
squares.add_lines("5", "5a", [0.4, 0.1, 0.6, 0.3], dashed=True, printed_label="E")
squares.add_lines("E", "Ea", [0.35, 0.15, 0.65, 0.45], dashed=True, printed_label="5", txt_offset=(-4, 0))
...
squares.add_lines("5", "5b", [0.4, 0.3, 0.6, 0.5], dashed=True, printed_label="E")
squares.add_lines("E", "Eb", [0.35, 0.35, 0.65, 0.65], dashed=True, printed_label="5", txt_offset=(-4, 0))
...
squares.add_lines("5", "5c", [0.4, 0.5, 0.6, 0.7], dashed=True, printed_label="E")
squares.add_lines("E", "Ec", [0.35, 0.55, 0.65, 0.85], dashed=True, printed_label="5", txt_offset=(-4, 0))
