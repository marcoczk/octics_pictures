...
squares.add_lines("", "5'", [0.5, 0, 0.5, 1], squares=["1", "2", "3", "4", "5"], dashed=True)
...
squares.add_lines("2'", "5'", [0.5, 0, 0.5, 1])
squares.add_lines("","2'",[0,0.5,1,0.5],squares=["1","2","5"])

# squares.add_lines("5'","1",[0,0.3,1,0.3])
squares.remove_line("1:5'")
squares.mark_no_intersection("2'","1","5'")
squares.add_lines("5'","2",[0,0.5,1,0.5])
squares.add_lines("5'","5",[0,0.7,1,0.7])
squares.add_lines("5'","2'",[0.5,0,0.5,1],dashed=True)
